...
import { translate } from '../../libs/translate/google/translate';
import Meaning from './Components/Meaning';
import Example from './Components/Example';
import Related from './Components/Related';
import { audio } from '../../libs/translate/google/audio';
const Popup = () => {
      ...
      <div className="flex justify-between py-2 px-2 border-b-[1px]">
        ...
        <div className="relative">
          ...
          <div
            className={`${
              appDropdown ? '' : 'hidden'
            } bg-gray-300 absolute top-[40px] p-2 flex flex-col rounded-xl gap-1 right-0 w-[200px]`}
          >
            <button
              className="p-2 border-[1px] rounded-xl flex justify-between items-center hover:bg-gray-100 transition-bg ease-in-out duration-100 gap-2 px-4 bg-gray-300"
              onClick={() => {
                setAppDropdown(false);
              }}
            >
              <span>Promodo</span>
              <GiTomato className="text-xl text-red-500" />
            </button>
            <button
              className="p-2 border-[1px] rounded-xl flex justify-between items-center hover:bg-gray-100 transition-bg ease-in-out duration-100 gap-2 px-4 bg-gray-300"
              onClick={() => {
          ...
          {isTranslating ? (
            isTranslated === false ? (
              <div className="w-full h-full flex flex-col gap-2 items-center justify-center text-lg">
                ...
                <h1 className="text-gray-600">Your translate result is here</h1>
              </div>
            ) : (
              <div className="w-full h-full flex flex-col gap-2 items-center justify-center text-lg">
